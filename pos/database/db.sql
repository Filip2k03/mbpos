...
CREATE TABLE `vouchers` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX `idx_vouchers_created_id` (`created_at`, `id`),
    INDEX `idx_vouchers_status_created_id` (`status`, `created_at`, `id`),
    INDEX `idx_vouchers_origin_region_created_id` (`region_id`, `created_at`, `id`),
    INDEX `idx_vouchers_destination_region_created_id` (`destination_region_id`, `created_at`, `id`),
    INDEX `idx_vouchers_origin_branch_created_id` (`origin_branch_id`, `created_at`, `id`),
    INDEX `idx_vouchers_destination_branch_status_created_id` (`destination_branch_id`, `status`, `created_at`, `id`),
    INDEX `idx_vouchers_receiver_phone` (`receiver_phone`),
    FOREIGN KEY (`region_id`) REFERENCES `regions`(`id`) ON DELETE CASCADE,
