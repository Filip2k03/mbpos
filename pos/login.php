                    ...
                    <tr>
                        <td style='background-color: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 24px; padding: 40px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);'>
                            ...
                            <p style='color: #64748b; font-size: 12px; text-align: center; margin: 0; line-height: 1.5;'>
                                ...
                                Engineered by <a href='https://thuyakyaw.com' target='_blank' rel='noopener noreferrer' style='color: #818cf8; text-decoration: none; font-weight: 600;'>Thuya Kyaw</a> &bull; <a href='https://payvia.asia' target='_blank' rel='noopener noreferrer' style='color: #818cf8; text-decoration: none;'>Payvia Asia</a>
                            </p>
                        </td>
                    </tr>
                </table>
