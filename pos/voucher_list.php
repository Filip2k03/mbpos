                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="flex items-center justify-end gap-1.5">
                                            ...
                                            <a href="index.php?page=voucher_create&duplicate_id=<?= (int)$voucher['id'] ?>" class="btn-ghost btn-sm text-slate-600 hover:text-blue-600 p-2" title="Duplicate as New" aria-label="Duplicate as New">
